            ...
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
              <div class="card card-login card-hidden">
                ...
                <div class="card-footer justify-content-center">                  
                  <button type="submit" class="btn btn-danger btn-link">Lets Go<div class="ripple-container"></div></button>
                </div>
              </div>
            </form>
          </div>
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            <a href="https://www.leereal.me" target="_blank">Leereal</a>. Excellence makes greatness achievable.
          </div>
        </div>
      </footer>
    </div>
